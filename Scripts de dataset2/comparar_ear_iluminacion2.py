...
DATASETS = {
    "40": os.path.join(script_dir, "..", "dataset2", "ojosabiertos_B40"),
    "25": os.path.join(script_dir, "..", "dataset2", "ojosabiertos_B25"),
    "15": os.path.join(script_dir, "..", "dataset2", "ojosabiertos_B15"),
    "10": os.path.join(script_dir, "..", "dataset2", "ojosabiertos_B10"),
    "5":  os.path.join(script_dir, "..", "dataset2", "ojosabiertos_B5")
}

CSV_SALIDA = "comparacion_EAR_iluminacion2.csv"
